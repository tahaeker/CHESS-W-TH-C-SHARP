...
class BoardHelper
{
    ...
    public static int IsValidFromToCondition(string from, string to, ChessContext ctx)
    {
        ...
        if (string.IsNullOrEmpty(from) || string.IsNullOrEmpty(to) || from[1] == null || to[1]==null)
        {
            //Console.WriteLine("From or To cannot be empty!!");
            return 1;
        }
        ...
        //from to ya eşit olamaz ekleeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
    }
